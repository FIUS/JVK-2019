...
/**
 * A child class of Neo.
 * This class is to be implemented by the students.
 *
...
public class MyNeo extends Neo {
     ...
     * @param starterCoins coin count that this neo starts with 
     */
    public MyNeo(int starterCoins) {
        this.setCoins(starterCoins);
        setCoinsInWallet(starterCoins); //doubling up to work around not implemented methods
    }
    
    /**
     * Moves this Neo entity twice.
